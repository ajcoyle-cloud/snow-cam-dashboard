  ...
  useEffect(() => {
    const fetchForecast = async () => {
      ...
      try {
        ...
        const summitUrl = `/api/om/v1/forecast?latitude=${r.lat}&longitude=${r.lon}&elevation=${r.summitElev}&hourly=temperature_2m,wet_bulb_temperature_2m,precipitation,precipitation_probability,snowfall,weather_code,windspeed_700hPa,winddirection_700hPa,windspeed_850hPa,winddirection_850hPa,freezinglevel_height&models=gfs_global&temperature_unit=celsius&wind_speed_unit=kmh&timezone=${r.timezone}&forecast_days=16`
        const baseUrl = `/api/om/v1/forecast?latitude=${r.lat}&longitude=${r.lon}&elevation=${r.baseElev}&hourly=temperature_2m,wet_bulb_temperature_2m,precipitation,precipitation_probability,snowfall,weather_code&models=gfs_global&temperature_unit=celsius&timezone=${r.timezone}&forecast_days=16`
        const ecmwfSummitUrl = `/api/om/v1/forecast?latitude=${r.lat}&longitude=${r.lon}&elevation=${r.summitElev}&hourly=temperature_2m,wet_bulb_temperature_2m,precipitation,precipitation_probability,snowfall,weather_code,windspeed_700hPa,winddirection_700hPa,windspeed_850hPa,winddirection_850hPa&models=ecmwf_ifs025&temperature_unit=celsius&wind_speed_unit=kmh&timezone=${r.timezone}&forecast_days=16`
        const ecmwfBaseUrl = `/api/om/v1/forecast?latitude=${r.lat}&longitude=${r.lon}&elevation=${r.baseElev}&hourly=temperature_2m,wet_bulb_temperature_2m,precipitation,precipitation_probability,snowfall,weather_code&models=ecmwf_ifs025&temperature_unit=celsius&timezone=${r.timezone}&forecast_days=16`
        ...
        const aifsBaseUrl = `/api/om/v1/forecast?latitude=${r.lat}&longitude=${r.lon}&elevation=${r.baseElev}&hourly=temperature_2m,wet_bulb_temperature_2m,precipitation,precipitation_probability,snowfall,weather_code&models=ecmwf_aifs025_single&temperature_unit=celsius&timezone=${r.timezone}&forecast_days=16`
        // UK Met Office seamless (global 10km, falls back from the UK-only 2km model outside Britain) — only a 7-day horizon.
        const ukmoSummitUrl = `/api/om/v1/forecast?latitude=${r.lat}&longitude=${r.lon}&elevation=${r.summitElev}&hourly=temperature_2m,wet_bulb_temperature_2m,precipitation,precipitation_probability,snowfall,weather_code,windspeed_700hPa,winddirection_700hPa,windspeed_850hPa,winddirection_850hPa&models=ukmo_seamless&temperature_unit=celsius&wind_speed_unit=kmh&timezone=${r.timezone}&forecast_days=16`
        const ukmoBaseUrl = `/api/om/v1/forecast?latitude=${r.lat}&longitude=${r.lon}&elevation=${r.baseElev}&hourly=temperature_2m,wet_bulb_temperature_2m,precipitation,precipitation_probability,snowfall,weather_code&models=ukmo_seamless&temperature_unit=celsius&timezone=${r.timezone}&forecast_days=16`
    ...
    Object.entries(RESORTS).forEach(async ([key, r]) => {
      ...
      try {
        const modelUrl = (model, elev) =>
          `/api/om/v1/forecast?latitude=${r.lat}&longitude=${r.lon}&elevation=${elev}&hourly=temperature_2m,precipitation,snowfall&models=${model}&temperature_unit=celsius&timezone=${r.timezone}&forecast_days=${COMPARE_FORECAST_DAYS}`
